...
import (
	...
	testloader "github.com/matthchr/controller-tools/pkg/loader/testutils"
)
...
var _ = BeforeSuite(func() {
	modules := []pkgstest.Module{
		{
			Name: "github.com/matthchr/controller-tools/pkg/markers/testdata",
	...
	var err error
	pkgs, exported, err = testloader.LoadFakeRoots(pkgstest.Modules, modules, "github.com/matthchr/controller-tools/pkg/markers/testdata")
